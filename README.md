...
Four example decks generated by the tool, demonstrating different frameworks, industries, and visual themes.

*Note: All samples use real publicly-listed company and government names as realistic test scenarios. The strategic situations, numbers, and recommendations are entirely fictional — generated by the tool for demonstration purposes only.*

| # | Client | Framework | Visual theme | Preview |
|---|--------|-----------|--------------|---------|
| 1 | Public Bank Berhad | Porter's Five Forces | Banking Blue | [📄 View PDF](https://github.com/gankaili88/pitch-deck-generator/blob/main/sample_decks/Sample01_Public_Bank_Berhad_Porter's_deck%20(1).pdf) |
| 2 | IHH Healthcare Berhad | Three Horizons | Healthcare Calm | [📄 View PDF](https://github.com/gankaili88/pitch-deck-generator/blob/main/sample_decks/Sample02_IHH_Healthcare_Berhad_Three_deck.pdf) |
| 3 | Malaysia Aviation Group / SIA | SCR | Consumer Vibrant | [📄 View PDF](https://github.com/gankaili88/pitch-deck-generator/blob/main/sample_decks/Sample03_Malaysia_Aviation_Group_(MAG%2C_parent_of_Malaysia_Airlines)_SCR_deck%20(1).pdf) |
| 4 | Ministry of Education Malaysia | MECE Issue Tree | Government Formal | [📄 View PDF](https://github.com/gankaili88/pitch-deck-generator/blob/main/sample_decks/Sample04_Ministry_of_Education_Malaysia_(MOE)_MECE_deck.pdf) |

Clicking any PDF link will open a preview directly in GitHub — no download needed.
